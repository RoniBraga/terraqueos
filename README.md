# Nave Mãe
revisando fundamentos de HTML e CSS e no fim tem um projeto de um formulário consolidando alguns conhecimentos adquiridos

<ul>
    <li>Fundamentos de HTML</li>
    <li>Fundamentos de CSS</li>
    <li>Projeto Formulário</li>
    <li>Futuro do Projeto</li>
</ul>


1 Fundamentos HTML: Nesses diversos arquivos revisitei alguns conceitos de HTML que a muito tempo estavam esquecidos. Passei pelas diferenças das tag´s <b>ol</b> e <b>ul</b>. Vi os diferentes tipos de input´s: text, password, radio, checkbox, hidden. Além das tag´s de paragrafos e ancora para passear pelo nosso site.<br><br>
